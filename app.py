from utils import processImage , readImages , extractImage
  ...
  try:
      ...
      if result:
         ...
         with zipfile.ZipFile(zippedFile, 'w') as f:
            [f.write(file) for file in glob.glob('outtxt1/*.txt')]
         shutil.copytree("outtxt1", "output_text" ,  dirs_exist_ok=True)
         shutil.rmtree("outtxt1")
